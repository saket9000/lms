...
from lms import attendance_datatables_views
...
urlpatterns = [
	...
	path('view-attendance-dt', login_required(attendance_datatables_views.AttendanceListDatatable.as_view()), 
	...
	path('edit-attendance/<int:attendance_id>', views.edit_attendance, name='edit-attendance'),
